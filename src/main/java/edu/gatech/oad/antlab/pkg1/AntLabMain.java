 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Bao Vu");
		  toPrint += p1.toString("bvu8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Michael Long");
		  toPrint += p2.toString("mlong42");
		  Person3 p3 = new Person3("Justin Buchanan");
		  toPrint += p3.toString("jbuchanan30");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Griffith");
          toPrint += p4.toString("lgriffith3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Philip Bale");
          toPrint += p5.toString("pbale3");
